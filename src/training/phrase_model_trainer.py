...
input_dir = os.getenv('DATA_PROCESSED_DIR', 'data/processed_lsp_phrase_sequences')
...
X_path = os.path.join(input_dir, 'X_lsp_phrase_sequences.npy')
y_path = os.path.join(input_dir, 'y_lsp_phrase_sequences.npy')
...
# Guardar el modelo
model.save(os.path.join(output_dir, 'cnn_lstm_lsp_letters_model.h5'))
